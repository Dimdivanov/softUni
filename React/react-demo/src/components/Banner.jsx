          ...
          <div className="container">
            <div className="row">
              <div className="col-md-8 col-sm-12">
                <div className="banner-text">
                  ...
                  <p className="banner-text white">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur hendrerit neque massa, sit amet
                    tristique ante porta ut. In sodales et justo vel vulputate. Pellentesque habitant morbi tristique
              ...
              <div className="col-md-4 col-sm-12">
                {' '}
                <img src="images/iphone-screen.png" className="img-fluid wow fadeInUp" />{' '}
              </div>
            </div>
          </div>
        </div>
